...
declare namespace dashjs {
  ...
  export interface RepresentationController {
    ...
    updateData(
      newRealAdaptation: object,
      availableRepresentations: object[],
      type: string,
  ...
  export interface SegmentsController {
    ...
    updateInitData(
      voRepresentation: Representation,
  ...
  export interface DashManifestModel {
    ...
    getEssentialPropertiesForRepresentation(realRepresentation: object): {
      schemeIdUri: string;
      value: string;
    };
  ...
  export interface MediaPlayerClass {
    ...
    on(
      type: InbandPrftReceivedEvent["type"],
      listener: (e: InbandPrftReceivedEvent) => void,
      scope?: object
    ): void;
  ...
  export interface CmcdModel {
    getQueryParameter(
      request: HTTPRequest
    ): { key: string; finalPayloadString: string } | null;
  ...
  export interface LowLatencyThroughputModel {
    ...
    addMeasurement(
      request: HTTPRequest,
      fetchDownloadDurationMS: number,
      chunkMeasurements: object[],
      requestTimeMS: number,
      throughputCapacityDelayMS: number
    ): void;
  ...
  export interface ProtectionKeyController {
    ...
    getSupportedKeySystemsFromContentProtection(
      cps: object[],
      protDataSet: ProtectionDataSet,
      sessionType: string
    ): object[]; //it says protDataSet but param is marked as protData
    ...
    getLicenseServerModelInstance(
      ...
      messageType: string
    ): any | null; // LicenseServer instead of any

    processClearKeyLicenseRequest(
      clearKeySystem: KeySystem,
  ...
  export interface KeySystem {
    ...
    getInitData(
      cp: object,
      cencContentProtection: object | null
    ): ArrayBuffer | null;
  ...
  export interface LoLpQoEEvaluator {
    ...
    logSegmentMetrics(
      segmentBitrate: number,
      segmentRebufferTime: number,
  ...
  export interface TTMLParser {
    parse(
      data: string,
      offsetTime: number,
      startTimeSegment: number,
      endTimeSegment: number,
      images: any[]
    ): {
      start: number;
      end: number;
  ...
  export interface SourceBufferSink {
    ...
    initializeForStreamSwitch(
      ...
      oldSourceBufferSink: SourceBufferSink
    ): Promise<any>;
